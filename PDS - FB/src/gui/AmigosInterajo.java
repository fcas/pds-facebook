 ...
 * @author larissa
 */
public class AmigosInterajo extends javax.swing.JPanel {
	private static final long serialVersionUID = -696956887408736877L;
	
	/**
     * Creates new form AmigosInterajo
     */
    public AmigosInterajo() {
        initComponents();
        menu_amigosinterajo.setFont(menu_amigosnome.getFont().deriveFont(Font.BOLD));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Amigos que mais interajo");
